      ...
      <div class="py-container">
        ...
        <div class="bread">
          ...
          <ul class="fl sui-tag">
            ...
            <li class="with-x" v-if="searchParams.keyword">{{searchParams.keyword}}<i @click="removeCategoryKeyword">×</i></li>
        ...
        <div class="details clearfix">
          ...
          <Pagination :currentPageNum="this.searchParams.pageNo"
          :pageSize="this.searchParams.pageSize"
          :total="this.goodsListInfo.total"
          :continueNum="5"
  ...
  export default {
    ...
    methods:{
      ...
      removeCategoryName(){
        ...
        // 在这直接发请求会有一个问题产生，就是地址栏的类别名还是存在的,我们应该让路由去变化发请求
        // this.getGoodsListInfo()
      ...
      removeCategoryKeyword(){
        this.searchParams.keyword = ''
         this.searchParams.pageNo = 1
        //使用全局事件总线，通知header组件清空搜索框
        this.$bus.$emit('clearKeyword')
        // this.getGoodsListInfo()
        // 在这直接发请求会有一个问题产生，就是地址栏的关键字还是存在的,我们应该让路由去变化发请求
        this.$router.replace({name:'search',params:this.$route.query})
      },
      removeTrademark(){
    ...
    watch:{
      $route(){
        // 因与beforemounte里一样，故我们需要封装函数，复用
        this.handlerSearchParams()
        // 路径变化需要再次发送请求
        this.getGoodsListInfo()
      }
