<template>
  <div class="trade-container">
    ...
    <div class="content">
      ...
      <div class="detail">
        <h5>商品清单</h5>
        <ul class="list clearFix" v-for="(detail,index) in detailArrayList" :key="detail.id">
          <li>
            <img :src="detail.imgUrl" alt="" style="width:100px;heiget:100px">
          </li>
          <li>
            <p>
              {{detail.skuName}}
  ...
  export default {
    ...
    methods:{
      ...
      async submitOrder(){
        ...
        if(result.code === 200){
          //请求创建订单成功，会返回一个订单编号，有了这个订单编号，再去跳转到支付页,接下来就可以携带这个订单编号去到支付页面
